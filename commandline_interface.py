    ...
    def display_main_menu(self):
        ...
        while True:
            ...
            if selection == '1':
                ...
                login_service = Login_Service(username, password) # Create instance of Login_Service class
                if login_service.authenticate_user_credentials(username, password): # If user credentials are valid
